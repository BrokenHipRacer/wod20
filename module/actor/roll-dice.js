...
export async function rollDice (
  ...
  function healthModifier (wound) {
    ...
    switch (true) {
      case wound.match('hurt'):
        return -1
      case wound.match('injured'):
        return -1
      case wound.match('wounded'):
        return -2
      case wound.match('mauled'):
        return -2
      case wound.match('crippled'):
        return -5
      case wound.match('incapacitated') :
        return -10000000
      default:
        return 0
    }
  ...
  let success = 0
  let critSuccess = 0
  const hungerCritSuccess = 0
  let fail = 0
  const hungerFail = 0
  const hungerCritFail = 0
